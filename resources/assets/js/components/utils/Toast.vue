...
<script>
    ...
    export default {
        ...
        computed: {
            theme() {
                return '_' + this.toast.options.theme;
            },

            style() {
                return `transform: translateY(${this.toast.options.directionOfJumping}${this.position * 100}%)`
            }
        },
        ...
        methods: {
            ...
            _startTimer() {
                if (!this.toast.options.closeBtn) {
